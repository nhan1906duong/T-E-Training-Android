...
class YoutubeDiffCallback @Inject constructor() : DiffUtil.ItemCallback<Youtube>() {
    override fun areItemsTheSame(oldItem: Youtube, newItem: Youtube) = oldItem.id == newItem.id

    override fun areContentsTheSame(oldItem: Youtube, newItem: Youtube) = oldItem.key == newItem.key
}