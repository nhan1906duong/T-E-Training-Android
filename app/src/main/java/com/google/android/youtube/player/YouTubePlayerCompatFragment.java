...
public class YouTubePlayerCompatFragment extends Fragment implements Provider {
    private final YouTubePlayerCompatFragment.a a = new YouTubePlayerCompatFragment.a();
    private Bundle b;
    ...
    public static YouTubePlayerCompatFragment newInstance() {
        return new YouTubePlayerCompatFragment();
    }

    public YouTubePlayerCompatFragment() {
    }
    ...
    private final class a implements b {
        ...
        public final void a(YouTubePlayerView var1, String var2, OnInitializedListener var3) {
            YouTubePlayerCompatFragment.this.initialize(var2, YouTubePlayerCompatFragment.this.e);
        }
